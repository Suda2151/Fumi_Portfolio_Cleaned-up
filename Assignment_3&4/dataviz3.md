...
1). Updated the title and axis explanation for the audience to understand easily.<br>
2). I separated a graph. One focuses on the number of travelers comparing domestic and international. The other focuses on the growing rate which implies which is a higher rate, and what happened if there are some spikes.<br>
...
The following graph shows how high each domestic and international travel business growth is. Orange colored bars show domestic(Thick: Expenditure, Thin: Tax revenue), and Blue colored shows international(Thick: Expenditure, Thin: tax revenue). The "Expenditure" means a profit from travel industry's point of view. <br>
